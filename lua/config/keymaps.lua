...
map({ "i", "n", "s" }, "<esc>", function()
  vim.cmd("noh")
  -- TODO: Add something to actually stop snippets
  return "<esc>"
...
map("n", "<leader>uF", function()
	...
	print("Autoformat (buffer): " .. tostring(vim.b.autoformat))
...
if vim.fn.executable("lazygit") == 1 then
  map("n", "<leader>gg", function() Snacks.lazygit( { cwd = utils.get_git_root() }) end, { desc = "Lazygit (Root Dir)" })
...
map("n", "<leader>gl", function() Snacks.picker.git_log({ cwd = utils.get_git_root() }) end, { desc = "Git Log" })
